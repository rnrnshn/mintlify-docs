...
- **Windows 11/10 ou MacOS (Ventura ou posterior recomendado). 🖥️**
...
- **Terminal: PowerShell (Windows) ou Terminal (MacOS). 🖱️**
...
**Ou baixe o instalador em **[**ollama.com**](http://ollama.com)** e siga as instruções.**
...
### **Passo 3: Configurar o SingleStore (Opcional para RAG) 🗄️**
...
### **Passo 6: Solução de Problemas 🛠️**
